...
The supplied review is preserved verbatim in review-ticket.md and review-context.md. The user's approved implementation plan adds the editable R4 local factor and joint criterion view. Modular scientific contracts remain authoritative. Status: qualified, deployed and verified; historical receipts describe their original commits.
